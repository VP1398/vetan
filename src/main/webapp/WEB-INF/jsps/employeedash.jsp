...
<body class="app sidebar-mini"  onload="go('mydashboard')" >
  <!-- Navbar-->
  <header class="app-header1" style="height: 55px;"><a class="app-header__logo" href="mydashboard" style="font-family: Georgia, 'Times New Roman', Times, serif; width: 230px; background-color: #055bac;height:50px;"><img src="images/vetan.jpg" width="230px" height="50px" style="margin-top: -2px; margin-bottom: -2px; margin-left: -15px; "></a>
...
<div class="tab" width="1050">
<button class="tablinks"  target="main" onclick="go('mydashboard')">Vetan</button>
<button class="tablinks" target="main" onclick="go('claim')">Claim Form</button>
<button class="tablinks"  target="main" onclick="go('tracker')">Claim Tracker</button>
<button class="tablinks"  target="main" onclick="go('grid/gridpayslip')">Pay Slip</button>
<button class="tablinks" target="main" onclick="go('it')">IT Declaration</button>
<button class="tablinks"  target="main" onclick="go('form16')">Form 16</button>
<button class="tablinks"  target="main" onclick="go('nominee')">Nominee </button>
<button class="tablinks" target="main" onclick="go('grat/gridempgrat')">Gratuity</button>
...
<script>
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item" href="charts"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">income Tax</span></a></li>
      ...
      <li><a class="app-menu__item" href="docs"><i class="app-menu__icon fa fa-file-code-o"></i><span class="app-menu__label">Deductions</span></a></li>
    </ul>
  </aside>
  <!-- right slidebar -->
