...
<body class="app sidebar-mini"  onload="go('grid/vetanpie.jsp')">
  ...
  <div id="main">
    ...
    <button class="tablinks" id="pat" data-toggle="modal" data-target="#myModal" onclick="go('grid/row')">NP_All</button>
    <button class="tablinks" id="pat" data-toggle="modal" data-target="#myModal" onclick="go('grid/row')">Ed. Expenses</button>
