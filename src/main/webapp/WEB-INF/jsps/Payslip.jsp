...
<body class="app sidebar-mini"  onload="go('grid/vetanpie')">
  ...
  <div id="main">
    ...
    <button class="tablinks" id="pat" data-toggle="modal" data-target="#myModal" onclick="go('grid/row.jsp')">NP_All</button>
    <button class="tablinks" id="pat" data-toggle="modal" data-target="#myModal" onclick="go('grid/row.jsp')">Ed. Expenses</button>
