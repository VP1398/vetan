    ...
    <head>
        ...
        $(document).ready(function () {
            // prepare the data
              ...
              result =[];
            $.getJSON("http://localhost:5135/customers/", function(response){
                    result = response;
            ...
            $("#grid").jqxGrid(
            {
                ...
                columns: [
                  ...
                  { text: 'Gender', datafield: 'male', width: 90, cellsalign: 'right' },
                  { text: 'Marriage Status', datafield: 'marriageStatus', width: 90, cellsalign: 'right', cellsformat: 'c2' },
