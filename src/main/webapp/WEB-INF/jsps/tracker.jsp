...
<body class="app sidebar-mini"  onload="go('tracker/gridtracker')">
  ...
  <div id="main">
    ...
    <button class="tablinks" id="pat" data-toggle="modal" data-target="#myModal" onclick="go('tracker/gridtracker')">My Claims</button>
    <button class="tablinks" id="pat" data-toggle="modal" data-target="#myModal" onclick="go('honor/gridmanager')">My Subordinates</button>													
