...
function initListeners(){
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#exampleModalLabel').text(button.data('expensetype')+' - '+button.data('plstatus'))
        modal.find('#modal-expenseType').val(button.data('expensetype'))
        modal.find('#modal-plStatus').val(button.data('plstatus'))
        modal.find('#modal-ltaLeavePeriod').val(button.data('ltaleaveperiod'))
        modal.find('#modal-egbBlockYear').val(button.data('egbblockyear'))
        modal.find('#modal-noEgbFmem').val(button.data('noegbfmem'))
        modal.find('#modal-actualMemTraveled').val(button.data('actualmemtraveled'))
        modal.find('#modal-travelEgb').val(button.data('travelegb'))
        modal.find('#modal-amountEgb').val(button.data('amountegb'))
