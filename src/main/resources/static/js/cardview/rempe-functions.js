...
function initListeners(){
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#exampleModalLabel').text(button.data('expensetype')+' - '+button.data('startdate'))
        ...
        modal.find('#modal-billNo').val(button.data('billno'))
        modal.find('#modal-billDate').val(button.data('billdate'))
        modal.find('#modal-noOfLitres').val(button.data('nooflitres'))
...
function updateAndSubmit(){
    ...
    document.getElementById("rempeForm").submit();
}
