...
function initListeners(){
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#exampleModalLabel').text(button.data('claimdate')+' - '+button.data('claimid'))
        modal.find('#modal-claimDate').val(button.data('claimDate'))
        modal.find('#modal-claimId').val(button.data('claimId'))
        modal.find('#modal-description').val(button.data('description'))
        modal.find('#modal-claimAmount').val(button.data('claimamount'))
        modal.find('#modal-approvalStatus').val(button.data('approvalstatus'))
        modal.find('#modal-approvalDate').val(button.data('approvaldate'))
         modal.find('#modal-paymentStatus').val(button.data('paymentstatus'))
        modal.find('#modal-settledDate').val(button.data('settleddate'))
...
function updateAndSubmit(){
    ...
    document.getElementById("remctForm").submit();
}
