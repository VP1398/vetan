...
function initListeners(){
    ...
    document.getElementById("inputGroupFile03").onclick = function(){
        ...
        $.ajax({
            url: '/CardView/remfestivaladv/uploadFile',
            type: 'POST',
            processData: false,
            contentType: false,
            dataType : 'json',
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#exampleModalLabel').text(button.data('festivalname')+' - '+button.data('entitledamount'))
	    modal.find('#modal-festivalName').val(button.data('festivalname'))
        ...
        modal.find('#modal-preFestivalName').val(button.data('prefestivalname'))
...
function updateAndSubmit(){
    ...
    document.getElementById("remfestivaladvForm").submit();
}
...
function removeAttachment(id){
    ...
    $.ajax({
        url: '/CardView/remfestivaladv/deleteFile',
        type: 'POST',
        processData: false,
        contentType: false,
        dataType : 'json',
