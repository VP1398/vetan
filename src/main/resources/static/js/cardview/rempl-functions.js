...
function initListeners(){
    ...
    $('#exampleModal').on('show.bs.modal', function (event) {
        ...
        modal.find('#exampleModalLabel').text(button.data('expensetype')+' - '+button.data('type'))
        modal.find('#modal-expenseType').val(button.data('expensetype'))
        modal.find('#modal-type').val(button.data('type'))
        modal.find('#modal-plBalance').val(button.data('plbalance'))
        modal.find('#modal-noOfDays').val(button.data('noofdays'))
        modal.find('#modal-newPlBalance').val(button.data('newplbalance'))
        modal.find('#modal-claimAmount').val(button.data('claimamount'))
        modal.find('#modal-availedDays').val(button.data('availeddays'))
        modal.find('#modal-balanceDays').val(button.data('balancedays'))
...
function updateAndSubmit(){
    ...
    document.getElementById("remplForm").submit();
}
