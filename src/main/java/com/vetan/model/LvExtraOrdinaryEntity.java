...
@Entity
@Table(name="lv_extraordinary")
public class LvExtraOrdinaryEntity {
	...
	public String toString() {
		return "LvExtraOrdinaryEntity [id=" + id + ", leaveType=" + leaveType +
				...
				", noOfDays=" + noOfDays +", noteForApprover=" + noteForApprover +", attachments=" + attachments +"]";
	}
}