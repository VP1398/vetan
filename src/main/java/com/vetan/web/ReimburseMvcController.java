...
import com.vetan.service.ReimburseService;
...
public class ReimburseMvcController
{
	...
	/**
	 * This method is used to fetch all reimburse entries from the database and
	 ...
	 */
	@RequestMapping
	public String getAllReimburses(Model model)
	{
		List<ReimburseEntity> list = service.getAllReimburses();

		model.addAttribute("reimburses", list);
		model.addAttribute("editReimburse", new ReimburseEntity());
		return "reimburse-list";
	}

	/**
	 * This method is used to delete reimburse entry from the database by its id.
	 * @param model This attribute is used to set values which will be used in the html template to populate data.
	 * @param id This is the reimburse id which is the primary key
	 * @return String This returns the name of the html page it has to be redirected.
	 */
	@RequestMapping(path = "/delete/{id}")
	public String deleteReimburseById(Model model, @PathVariable("id") Long id)
							throws RecordNotFoundException 
	{
		service.deleteReimburseById(id);
	 ...
	 * @param reimburse This is the reimburse entity with all its value pre-populated.
	 * @return String This returns the name of the html page it has to be redirected.
	 */
	@RequestMapping(path = "/createReimburse", method = RequestMethod.POST)
	public String createOrUpdateReimburse(ReimburseEntity reimburse)
	{
		service.createOrUpdateReimburse(reimburse);
		return "redirect:/reimburse";
	}
