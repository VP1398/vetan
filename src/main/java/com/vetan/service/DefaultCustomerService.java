...
import com.vetan.data.Customer;
import com.vetan.dto.CustomerData;
import com.vetan.repository.CustomerRepository;
...
public class DefaultCustomerService implements CustomerService{
    ...
    private CustomerData populateCustomerData(final Customer customer){
        ...
        customerData.setJoiningDate(customer.getJoiningDate());
        customerData.setMale(customer.getMale());
        customerData.setMarriageStatus(customer.getMarriageStatus());
        return  customerData;
    }
